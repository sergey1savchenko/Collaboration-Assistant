...
public class StudentDaoImpl implements StudentDao {
	...
	public Map<Student, StudentProjectStatusType> getStudentsByProject(Project project) {
		return jdbcTemplate.query(SQL_SELECT_STUDENTS_BY_PROJECT, new ResultSetExtractor<Map<Student, StudentProjectStatusType>>() {
	...
	public List<StudentProjectStatus> getStudentProjectStatuses(final Student student, final Project project) {
		return jdbcTemplate.query(SQL_SELECT_STUDENT_PROJECT_STATUSES, new ResultSetExtractor<List<StudentProjectStatus>>() {

			public List<StudentProjectStatus> extractData(ResultSet rs) throws SQLException, DataAccessException {
