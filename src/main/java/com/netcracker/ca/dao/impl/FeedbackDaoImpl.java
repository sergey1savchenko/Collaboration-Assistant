...
public class FeedbackDaoImpl implements FeedbackDao {
	...
	private static final String SQL_SELECT_FEEDBACK_BY_STUDENT_ID = SQL_SELECT_ALL_FEEDBACKS + " WHERE feedbacks.app_form_id = ?";
	...
	@Override
	public Feedback getByStudentId(Integer id) {
		List<Feedback> feedbacks = jdbcTemplate.query(SQL_SELECT_FEEDBACK_BY_STUDENT_ID, new FeedbackMapper(), id);
		return feedbacks.isEmpty()? null: feedbacks.get(0);
	}
