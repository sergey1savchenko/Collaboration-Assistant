...
public class StudentDaoImpl implements StudentDao {
	...
	public Student getByAppFormId(int appFormId) {
		List<Student> students =  jdbcTemplate.query(SQL_SELECT_STUDENT_BY_APP_FORM_ID, new StudentRowMapper(), appFormId);
		return students.isEmpty()? null: students.get(0);
	}
	...
	public void update(Student student) {
		jdbcTemplate.update(SQL_UPDATE_USER, student.getEmail(), student.getPassword(), student.getFirstName(),
