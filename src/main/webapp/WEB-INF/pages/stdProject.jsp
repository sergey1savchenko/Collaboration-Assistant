...
<div class="container">
	...
	<!-- ${team} 
	${projects}  -->
	<h3>Your team is "${team.title}" in <c:forEach var="project" items="${projects}"><c:if test="${team.project.id == project.id}">"${project.title}"</c:if></c:forEach> project</h3>
...
<script type="text/javascript" src="<c:url value="/resources/js/pages/stdProject.js"/>"></script>
</body>
</html>